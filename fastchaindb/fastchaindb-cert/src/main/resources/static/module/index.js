    ...
    var index = {
        ...
        checkPageTabs: function () {
            if (index.pageTabs) {
                ...
                if (index.userId == 1 || index.userId == 2){
                    $('#home_console').load('home/console');
                    console.log(index.userId);
                }else{
                    $('#home_console').load('cert/certinfo');
                    console.log(index.userId);
                }
            } else {
        ...
        bindEvent: function () {
            ...
            $('#setPsw').click(function () {
                admin.popupRight('home/password', '336px');
            });

            // 个人信息点击事件
            $('#setInfo').click(function () {
                admin.popupRight('home/user', '420px');
            });

            // 消息点击事件
            $('#btnMessage').click(function () {
                admin.popupRight('home/message', '336px');
            });
        }
    };
