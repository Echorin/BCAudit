...
import com.oschain.fastchaindb.common.shiro.EndecryptUtil;
import com.oschain.fastchaindb.common.utils.Base58;
import com.oschain.fastchaindb.common.utils.DESUtil;
...
import com.oschain.fastchaindb.system.dao.UserRoleMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public boolean add(User user) throws BusinessException {
        ...
        //生成密钥
        String accessId=UUIDUtil.randomUUID32();
        byte[] result = DESUtil.encrypt(accessId.getBytes());
        String accessKey = Base58.encode(result);
