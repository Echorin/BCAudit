 ...
 */
public interface ProofFileService extends IService<ProofFile> {
    ...
    int save(ProofFile proofFile);

    BigInteger sumFileSize();

    PageResult<ProofFile> list(int pageNum, int pageSize, Map<String, Object> condition);
