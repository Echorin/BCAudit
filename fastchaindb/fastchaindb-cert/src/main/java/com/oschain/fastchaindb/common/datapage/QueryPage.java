...
public class QueryPage {
	...
	/**　小计字段[sl1,"0"]    */
	private java.util.Map<String, String> FieldSum=new HashMap<String, String>();

	public Map<String, String> getFieldSum() {
		return FieldSum;
	}

	public void setFieldSum(Map<String, String> fieldSum) {
		FieldSum = fieldSum;
	}
